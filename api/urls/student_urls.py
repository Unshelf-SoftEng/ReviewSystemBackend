...
urlpatterns = [
    ...
    path('assessment/<int:assessment_id>/limit', student_views.teacher_assessment_limit, name='teacher_assessment_limit'),
    path('assessment/<int:assessment_id>/take', student_views.take_teacher_assessment, name='take_teacher_assessment'),
    path('assessment/<int:assessment_id>/class-results', student_views.get_class_assessment_result, name='get_class_assessment_result'),
    path('assessment/<int:assessment_id>/class-submit', student_views.submit_class_assessment, name='submit_class_assessment'),
    ...
    path('take-lesson-assessment/<int:lesson_id>', student_views.take_lesson_assessment, name='take_lesson_assessment'),
    path('take-chapter-assessment/<int:chapter_id>', student_views.take_chapter_assessment, name='take_chapter_assessment'),
    path('final-exam', student_views.get_final_exam, name='get_final_exam'),
    path('take-final-exam', student_views.take_final_exam, name='take_final_exam'),
    path('final-exam-taken', student_views.final_exam_taken, name='final_exam_taken'),
]
