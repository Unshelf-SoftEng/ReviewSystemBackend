...
urlpatterns = [
    ...
    path('update-password/<str:access_token>/', general_views.update_password, name='password_update'),
    path('reset-password/', general_views.reset_password, name='reset_password'),
]